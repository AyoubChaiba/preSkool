                    ...
                    <div class="row">
                            ...
                            <div class="dash-details">
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-01.svg")}}" alt="">
                                    </div>
                                ...
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-02.svg")}}" alt="">
                                    </div>
                                    <div class="views-lesson">
                                        <h5>Lessons</h5>
                                        <h4>5 Lessons</h4>
                                ...
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-03.svg")}}" alt="">
                                    </div>
                                    <div class="views-lesson">
                                        <h5>Time</h5>
                                        <h4>Lessons</h4>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="dash-details">
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-04.svg")}}" alt="">
                                    </div>
                                    <div class="views-lesson">
                                        <h5>Asignment</h5>
                                        <h4>5 Asignment</h4>
                                ...
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-05.svg")}}" alt="">
                                    </div>
                                    <div class="views-lesson">
                                        <h5>Staff</h5>
                                        <h4>John Doe</h4>
                                ...
                                <div class="lesson-activity">
                                    <div class="lesson-imgs">
                                        <img src="{{asset("assets/img/icons/lesson-icon-06.svg")}}" alt="">
                                    </div>
                                    <div class="views-lesson">
